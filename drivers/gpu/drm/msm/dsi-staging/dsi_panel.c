...
char gamma_para[2][413] = {
	{ /* Level2 key Enable */
	  ...
	  ,
	  /* 180 parameter read value (60Hz) */
	  ,
	  /*0xB0 0x02*/
	  0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x02,
	  /* 45 parameter read value (60Hz) */
	  0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2E, 0xB3, 0xAE, 0xA9, 0x95,
	  0xC7, 0x68, 0x08, 0x77, 0x28, 0xB6, 0x27, 0xE1, 0x63, 0xB6, 0x7D,
	  0xF1, 0x55, 0x54, 0x40, 0x64, 0x31, 0x98, 0x34, 0x07, 0x67, 0x06,
	  0xDF, 0x33, 0xC7, 0xA3, 0xE5, 0x00, 0x00, 0x00, 0xA3, 0x93, 0xC6,
	  0x0A, 0x01, 0x01, 0x37, 0x37, 0x37, 0x00, 0x00, 0x00,
	  /* level2_key Disable */
	...
	{ /* Level2 key Enable */
	  ...
	  ,
	  /* 180 parameter read value (90Hz) */
	  ,
	  /*0xB0 0x02*/
	  0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0xB0, 0x02,
	  /* 45 parameter read value (90Hz) */
	  0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2E, 0xB3, 0xAE, 0xA9, 0x95,
	  0xC7, 0x68, 0x08, 0x74, 0x26, 0xB3, 0x22, 0xDC, 0x5F, 0xB5, 0x7C,
	  0xF0, 0x55, 0x54, 0x40, 0x62, 0x31, 0x98, 0x34, 0x07, 0x66, 0x06,
	  0xDF, 0x32, 0xC9, 0xA9, 0xE9, 0x00, 0x00, 0x00, 0xAD, 0x9D, 0xCE,
	  0x0D, 0x01, 0x01, 0x37, 0x37, 0x37, 0x00, 0x00, 0x00,
	  /* level2_key Disable */
	  0x39, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF0, 0xA5, 0xA5 }
...
int dsi_panel_gamma_read_address_setting(struct dsi_panel *panel,
					 u16 read_number)
{
	int rc = 0;
...
static int dsi_panel_parse_gpios(struct dsi_panel *panel)
{
	...
	panel->poc =
		utils->get_named_gpio(utils->data, "qcom,platform-poc-gpio", 0);
	if (!gpio_is_valid(panel->poc)) {
	...
	panel->vddd_gpio =
		utils->get_named_gpio(utils->data, "qcom,vddd-gpio", 0);
	if (!gpio_is_valid(panel->vddd_gpio)) {
		pr_err("[%s] vddd-gpio is not set, rc=%d\n", panel->name, rc);
	}

	panel->tp1v8_gpio =
		utils->get_named_gpio(utils->data, "qcom,tp1v8-gpio", 0);
	if (!gpio_is_valid(panel->tp1v8_gpio)) {
		pr_err("[%s] tp1v8_gpio is not set, rc=%d\n", panel->name, rc);
	}

	panel->err_flag_gpio =
		utils->get_named_gpio(utils->data, "qcom,err-flag-gpio", 0);
...
static int dsi_panel_parse_bl_config(struct dsi_panel *panel)
{
	...
	rc = utils->read_u32(utils->data, "qcom,mdss-brightness-default-val",
			     &val);
	if (rc) {
		pr_debug(
			"[%s] brightness-default-val unspecified, defaulting to val\n",
			panel->name);
				      ...
				      struct device_node *of_node)
{
	...
	panel_manufacture = of_get_property(
		of_node, "qcom,mdss-dsi-panel-manufacture", NULL);
	if (!panel_manufacture)
		pr_err("%s:%d, panel manufacture not specified\n", __func__,
		       __LINE__);
	panel_version =
		of_get_property(of_node, "qcom,mdss-dsi-panel-version", NULL);
	if (!panel_version)
		pr_err("%s:%d, panel version not specified\n", __func__,
		       __LINE__);

	backlight_manufacture = of_get_property(
		of_node, "qcom,mdss-dsi-backlight-manufacture", NULL);
	if (!backlight_manufacture)
		pr_err("%s:%d, backlight manufacture not specified\n", __func__,
		       __LINE__);
	backlight_version = of_get_property(
		of_node, "qcom,mdss-dsi-backlight-version", NULL);
	...
	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-year-index", &tmp);
	panel->panel_year_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-mon-index", &tmp);
	panel->panel_mon_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-day-index", &tmp);
	panel->panel_day_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-hour-index", &tmp);
	panel->panel_hour_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-min-index", &tmp);
	panel->panel_min_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(
		of_node, "qcom,mdss-dsi-panel-seria-num-sec-index", &tmp);
	panel->panel_sec_index = (!rc ? tmp : 0);

	rc = of_property_read_u32(of_node, "qcom,mdss-dsi-panel-status-value-2",
				  &tmp);
	panel->status_value = (!rc ? tmp : 0);

	panel->panel_mismatch_check = of_property_read_bool(
		of_node, "qcom,mdss-panel-mismatch-check");
...
static ssize_t brightness_enable_read(struct file *file, char __user *user_buf,
...
static ssize_t brightness_enable_write(struct file *file,
		       ...
		       struct mipi_dsi_host *host)
{
	...
	prEntry_tmp = proc_create("brightness_event_num", 0664, prEntry_tp,
	...
	prEntry_tmp = proc_create("brightness_enable", 0666, prEntry_tp,
				  &brightness_enable_fops);
	if (prEntry_tmp == NULL) {
	...
	if ((strcmp(panel->name, "samsung dsc cmd mode oneplus dsi panel") == 0) &&
		...
		if (mode_fps == 90) {
			rc = dsi_panel_tx_gamma_cmd_set(
				panel, DSI_GAMMA_CMD_SET_SWITCH_90HZ);
...
int dsi_panel_enable(struct dsi_panel *panel)
{
	...
	if ((EVT2_113MHZ_OSC == panel->panel_stage_info) ||
	    (PVT_113MHZ_OSC == panel->panel_stage_info) ||
	    (PVT_113MHZ_OSC_XTALK == panel->panel_stage_info)) {
	...
	if (hbm_brightness_flag == 0) {
		...
		if (!count) {
			...
			rc = dsi_panel_tx_cmd_set(
				panel, DSI_CMD_SET_HBM_BRIGHTNESS_ON);
...
int dsi_panel_parse_gamma_cmd_sets(void)
{
	...
	for (i = 0; i < 2; i++) {
		rc = dsi_panel_parse_gamma_cmd_sets_sub(
			&gamma_cmd_set[i], (char *)&gamma_para[i],
			sizeof(gamma_para) / 2, DSI_CMD_SET_STATE_HS, i);
		if (rc) {
